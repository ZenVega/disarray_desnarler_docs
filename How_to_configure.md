...
If you feel comfortable with coding: this is just an easy intro for people less comfortable to change the Desnarler according to their needs. It might still be a good start for you as well, but of course you are free to look at the whole code povided.
...
Let us dive into a more complex example, using the default_pure_linux keymap we provided.
