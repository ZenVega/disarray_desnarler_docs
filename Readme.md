...
After you are done soldering, it is time to flash your Desnarler with some QMK firmware to make it ready for use. Let's first use a keymap we provide you.
